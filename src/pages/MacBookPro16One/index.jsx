        ...
        <div className="flex flex-col items-center justify-start w-full mb-[5px]">
          <div className="flex flex-col items-center justify-start w-full overflow-auto">
            <div className="flex flex-col items-center justify-start w-full">
                ...
                <div className="flex flex-row justify-end w-full mx-auto max-w-[1253px]">
                  <div className="flex flex-col items-start justify-start w-full">
                    ...
                    <div className="flex flex-col items-center justify-start mt-[74px]">
                      ...
                      <Button
                        size="xs"
                        className="w-[49px] mt-[23px] bg-[url(/public/images/img_mask_group_1.png)] bg-cover bg-no-repeat"
                      >
                        <Img src="images/img_mask_group_49x49.svg" />
                      </Button>
                    </div>
              ...
              <div className="h-[716px] w-[92%] relative">
                ...
                <Text
                  size="2xl"
                  as="p"
                  className="w-[47%] bottom-[12%] left-[8%] m-auto !text-cyan-800 italic absolute"
                >
              ...
              <Img
                src="images/img_rectangle_4405_39x1728.png"
                alt="image_two"
                className="w-full mt-[90px] object-cover"
              />
              <Img
                src="images/img_rectangle_4406_39x1728.png"
                alt="image_three"
              ...
              <div className="flex flex-row justify-center w-full mt-[107px]">
                <div className="flex flex-col items-center justify-start w-full">
                  ...
                  <Img
                    src="images/img_rectangle_4407_1.png"
                    alt="image_twelve"
              ...
              <Img
                src="images/img_rectangle_4408_1.png"
                alt="image_thirteen"
                className="w-full mt-[15px] object-cover"
              />
                  ...
                  <div className="flex flex-row justify-center w-full">
                    <div className="flex flex-col items-center justify-start w-full gap-[58px]">
                      <div className="flex flex-row justify-start w-full gap-[27px]">
                        ...
                        <MacBookPro16TwoRowTwentythree className="flex flex-row justify-start w-[31%]" />
              ...
              <MacBookPro16TwoRowaerialviewon className="h-[858px] w-full mt-[121px] relative" />
              <div className="flex flex-col items-center justify-start w-[44%] mt-[77px] gap-[26px]">
                <Heading size="4xl" as="h1" className="w-[51%] !text-gray-400 tracking-[-1.80px] text-center">
                  <span className="text-gray-600 text-3xl">
                    TAKE A<br />
                  </span>
                  <span className="text-cyan-800 text-[50px]">TOUR</span>
                </Heading>
                <Text size="lg" as="p" className="!text-black-900 text-center">
                  Tula&#39;s University boasts a lush green campus complemented by a meticulously maintained sports
                  complex, offering students an invigorating environment for both academic and athletic pursuits. Amidst
                  the verdant surroundings, students at Tula&#39;s University find an ideal setting to excel
                  academically while embracing a healthy and active lifestyle through its top-notch sports facilities
                </Text>
              </div>
              <div className="flex flex-row justify-center w-full mt-[50px]">
                <div className="flex flex-col items-center justify-start w-full">
                  <div className="h-[56px] w-px bg-pink-800" />
                  <MacBookPro16TwoRowFortyeight className="flex flex-row justify-start w-full mt-[-48px] pl-[589px] pr-14 max-w-[2925px]" />
                </div>
              </div>
              <Img
                src="images/img_rectangle_4444_39x1728.png"
                alt="image_thirtysix"
                className="w-full mt-[42px] object-cover"
              />
              <div className="flex flex-col items-center justify-start w-full mt-[15px]">
                <Img src="images/img_rectangle_4445_39x1728.png" alt="image" className="w-full object-cover" />
                <div className="h-[728px] w-full mt-[-1px] relative">
                  ...
                  />
                  <div className="flex flex-row justify-center w-full h-full left-0 bottom-0 right-0 top-0 p-[50px] m-auto bg-gradient2 absolute">
              ...
              <Img src="images/img_rectangle_4407_2.png" alt="image_fortytwo" className="w-full object-cover" />
              <Img src="images/img_rectangle_4408_2.png" alt="image" className="w-full mt-[15px] object-cover" />
            </div>
            ...
            <div className="h-[783px] w-full mt-[55px] relative">
              <Img
                src="images/img_rectangle_4404_655x1728.png"
                alt="image"
              ...
              <div className="justify-center h-[783px] w-full left-0 bottom-0 right-0 top-0 m-auto absolute">
                ...
                <div className="flex flex-row justify-start w-full gap-[37px] bottom-[20%] right-0 left-0 m-auto absolute">
                  <div className="h-[278px] w-[18%] shadow-xs relative">
                    <Img
                  ...
                  <div className="flex flex-row w-[61%] gap-[559px]">
                    <div className="h-[278px] w-[30%] shadow-xs cursor-pointer relative hover:shadow-xs">
                      <Img
                    ...
                    <div className="flex flex-row justify-center w-[30%] cursor-pointer hover:shadow-xs">
